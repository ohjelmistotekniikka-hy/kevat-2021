...
Harjoitustyön tekeminen aloitetaan päättämällä aihe ja kuvaamalla se _alustavassa määrittelydokumentissa_, eli työlle tehdään [vaatimusmäärittely](https://github.com/ohjelmistotekniikka-hy/kevat-2021/blob/main/web/materiaali.md#vaatimusmäärittely).

Aihetta miettiessäsi kannattaa ehdottomasti lukea [ohjeet työn aloittamiseen](https://github.com/ohjelmistotekniikka-hy/kevat-2021/blob/main/web/tyon_aloitus.md).

- Huomaa, että harjoitustyön koodi tulee toteuttaa [maven](https://github.com/ohjelmistotekniikka-hy/kevat-2021/blob/main/web/tyon_aloitus.md#maven-projektin-luominen)-muotoisena projektina
...
Palautus tapahtuu lisäämällä oman aiheen _alustava määrittelydokumentti_ ensimmäisen viikon [laskareiden](https://github.com/ohjelmistotekniikka-hy/kevat-2021/blob/main/tehtavat/viikko1.md#labtool) päätteeksi [labtooliin](https://study.cs.helsinki.fi/labtool/courses/TKT20002.2021.K.K.1) rekisteröimääsi palautusrepositorioon.
