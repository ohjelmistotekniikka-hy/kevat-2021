...
Huomaa, että tällä viikolla on myös harjoitustyöhön liittyviä [tavoitteita](https://github.com/ohjelmistotekniikka-hy/kevat-2021/blob/main/tehtavat/harjoitustyo_viikko2.md)

## 1

- tutustu [JUnit-ohjeeseen](https://github.com/ohjelmistotekniikka-hy/kevat-2021/blob/main/web/junit.md)
...
- mene hakemistoon, jossa projekti sijaitsee
  ...
  - jos et jostain syystä saa mavenia toimimaan komentoriviltä, niin voit käyttää sitä NetBeansin kautta [tämän](https://github.com/ohjelmistotekniikka-hy/kevat-2021/blob/main/tehtavat/viikko2.md#maven-komentojen-suorittaminen-netbeansista) ohjeen avulla
...
Talleta kohdassa [testikattavuus](https://github.com/ohjelmistotekniikka-hy/kevat-2021/blob/main/tehtavat/viikko2.md#3-testauskattavuus) olevan kuvan tyylinen [screenshot](https://www.take-a-screenshot.org/) projektisi kattavuusraportista palautusrepositoriosi hakemistoon _laskarit/viikko2_.
