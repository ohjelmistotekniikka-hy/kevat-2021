...
- palautusrepositorioistasi on GitHub-issuet sallittuna, ks. [ohje](https://github.com/ohjelmistotekniikka-hy/kevat-2021/blob/main/tehtavat/harjoitustyo_viikko5.md#issueiden-salliminen)
...
- Ohjelmasta pystyy tekemään suorituskelpoisen [jar](https://github.com/ohjelmistotekniikka-hy/kevat-2021/blob/main/web/maven.md#jarin-generointi)-tiedoston komennolla _mvn package_ (0.5p)
- Projektista on tehty _github release_ (0.25p)
  - Release sisältää ohjelman uusimman version suorituskelpoisen jar-tiedoston
  - [Ohje](https://github.com/ohjelmistotekniikka-hy/kevat-2021/blob/main/web/release.md) releasen tekemiseen
...
- Testaus on edennyt (0.5p)
  ...
  - Käyttöliittymän rakentava koodi [jätetään pois](https://github.com/ohjelmistotekniikka-hy/kevat-2021/blob/main/web/maven.md#koodin-huomiotta-jättäminen-kattavuusraportissa) testikattavuusraportista
...
- Koodin laatu (0.5p)
  - Sovelluslogiikka on eriytetty käyttöliittymästä
    - Vihjeitä [täällä](https://github.com/ohjelmistotekniikka-hy/kevat-2021/blob/main/web/java.md) ja [referenssisovelluksessa](https://github.com/mluukkai/OtmTodoApp/blob/master/dokumentaatio/arkkitehtuuri.md)
  - Ohjelman [pakkausrakenne](https://github.com/ohjelmistotekniikka-hy/kevat-2021/blob/main/web/koodin_laatuvaatimukset.md#5-pakkaukset) heijastaa ohjelman loogista rakennetta ja on nimennältään järkevä
...
- Ohjelman dokumentaatiossa on ainakin yksi sen jotain oleellista toiminnallisuutta kuvaava sekvenssikaavio (0.5p)
  ...
  - Lisää kaavio [edellisellä viikolla](https://github.com/ohjelmistotekniikka-hy/kevat-2021/blob/main/tehtavat/harjoitustyo_viikko4.md) tehtyyn dokumenttiin _arkkitehtuuri.md_
...
- Palautusrepositorioosi voi tehdä GitHub-issuieta, ks [ohje](https://github.com/ohjelmistotekniikka-hy/kevat-2021/blob/main/tehtavat/harjoitustyo_viikko5.md#issueiden-salliminen)
