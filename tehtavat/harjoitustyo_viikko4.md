...
- Koodin laatu (1p)
  ...
  - Checkstyle on otettu käyttöön
    - Ohje Checkstylen käyttöönottoon [täällä](https://github.com/ohjelmistotekniikka-hy/kevat-2021/blob/main/web/checkstyle.md)
...
- Ohjelman alustava rakenne luokka/pakkauskaaviona (0.75p)
  ...
  - Voit tarvittaessa tehdä kaavion, josta ilmenee myös sovelluksen [pakkausrakenne](https://github.com/ohjelmistotekniikka-hy/kevat-2021/blob/main/web/materiaali.md#pakkauskaavio)
