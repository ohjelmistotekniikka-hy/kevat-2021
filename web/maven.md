...
Ohje maven-muotoisen projektin luomiseen NetBeansilla [täällä](https://github.com/ohjelmistotekniikka-hy/kevat-2021/blob/main/web/tyon_aloitus.md#maven-projektin-luominen)
...
Katso lisää [viikon 2 laskareista](https://github.com/ohjelmistotekniikka-hy/kevat-2021/blob/main/tehtavat/viikko2.md#3-testauskattavuus).
...
Ohje [täällä](https://github.com/ohjelmistotekniikka-hy/kevat-2021/blob/main/tehtavat/viikko2.md#maven-komentojen-suorittaminen-netbeansista).
...
Katso lisää [täältä](https://github.com/ohjelmistotekniikka-hy/kevat-2021/blob/main/web/javadoc.md)
...
JavaFX aiheuttaa hankaluuksia myös seuraavassa luvussa esitettyyn jar-tiedostojen generointiin, eräs tapa ongelmien kiertämiseen on kerrottu sitä seuraavassa luvussa [täällä](https://github.com/ohjelmistotekniikka-hy/kevat-2021/blob/main/web/maven.md#javafx-ja-jar).
